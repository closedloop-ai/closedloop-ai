...
export const RUNNER_UNKNOWN_SKILL_LOOP_ERROR = {
  code: LoopErrorCode.RunnerError,
  message: "Claude reported an unknown slash command.",
  result: { subcode: RunnerErrorSubcode.ClaudeUnknownSkill },
} satisfies NonNullable<Loop["error"]>;

export const RUNNER_UNKNOWN_SKILL_EVENT: LoopEvent = {
  type: LoopEventType.Error,
  code: RUNNER_UNKNOWN_SKILL_LOOP_ERROR.code,
  message: RUNNER_UNKNOWN_SKILL_LOOP_ERROR.message,
  timestamp: "2026-01-01T00:00:00.000Z",
  result: RUNNER_UNKNOWN_SKILL_LOOP_ERROR.result,
};

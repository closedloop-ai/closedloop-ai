...
/**
 * A thin strip of colored dots over the branch timeline marking exact
 * moments like actions, commits, or failures, rather than the volume of work
 * the bars underneath show.
 */
const meta = {

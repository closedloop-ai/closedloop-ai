...
/**
 * Stacked bars showing cost per hour on a branch, split by who spent it, for
 * seeing when and by whom money went rather than when sessions ran, unlike
 * the session swimlane.
 */
const meta = {

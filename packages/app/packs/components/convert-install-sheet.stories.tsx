...
/**
 * A side panel for installing a skill, agent, or hook onto a different AI
 * harness, showing whether the conversion will be clean, drop fields, or
 * can't happen before you confirm.
 */
const meta = {

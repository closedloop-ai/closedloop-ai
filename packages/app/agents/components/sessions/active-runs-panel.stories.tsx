...
/**
 * The card on the Sessions page showing which agent sessions are running
 * right now, with a live phase badge, running time, and token count, as a
 * companion to the full table.
 */
const meta = {

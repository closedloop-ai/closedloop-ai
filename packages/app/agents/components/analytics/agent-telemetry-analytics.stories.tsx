...
/**
 * The usage and cost analytics screen for spend and usage patterns across
 * many sessions rather than one session's own breakdown, reporting API and
 * subscription usage separately.
 */

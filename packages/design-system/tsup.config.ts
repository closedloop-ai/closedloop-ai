...
export default defineConfig({
  entry: [
    ...
    "providers/theme.tsx",
    "lib/utils.ts",
    "components/ui/primitives/info-hint.tsx",
    "components/ui/primitives/metric-polarity.ts",
    "components/ui/table-page-size-select.tsx",
    "components/ui/table-pagination-footer.tsx",
    "components/ui/tone-label.tsx",
    "hooks/use-container-width.ts",
    "hooks/use-settled-value.ts",
    "lib/collapse-columns.ts",
    "lib/column-fold.ts",
    "lib/column-order.ts",
    "lib/grid-table-aria.ts",
    "lib/grid-table-navigation.ts",
    "components/ui/brand-icons.tsx",
    "components/ui/card-density.ts",
    "components/ui/chart-series-fold.ts",
    "components/ui/donut-slice-textures.tsx",
    "components/ui/internal/status-icon-shared.tsx",
    "components/ui/primitives/activity-heatmap-colors.ts",
    "components/ui/primitives/graph-events.ts",
    "components/ui/table-grid-column-menu.tsx",
    "components/ui/table-saved-views-switcher.tsx",
    "hooks/use-responsive-modal.tsx",
    "lib/table-saved-views.ts",
  ],
  format: ["esm", "cjs"],
  dts: true,
  clean: true,

 ...
 *   Full access:  sk_test_mcp_test_seed_key_0123456789abcdef
 *   Read-only:    sk_test_mcp_test_readonly_key_abcdef0123
 */
...
const MCP_TEST_KEY = "sk_test_mcp_test_seed_key_0123456789abcdef";
const MCP_TEST_KEY_SCOPES = ["read", "write", "delete", "admin"] as const;
const MCP_TEST_KEY_HASH = createHash("sha256")
  .update(MCP_TEST_KEY)
  .digest("hex");

const MCP_READONLY_KEY = "sk_test_mcp_test_readonly_key_abcdef0123";

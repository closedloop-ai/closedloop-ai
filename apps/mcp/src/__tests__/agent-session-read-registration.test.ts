...
describe("agent-session read tool registration", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("registers the session read tools with read scope", async () => {
  ...
  it("withholds the session read tools from write-only and empty grants", async () => {

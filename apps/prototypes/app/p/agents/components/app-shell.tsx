...
const CrumbContent = ({ crumb }: { crumb: Crumb }) => {
  ...
  // A clickable crumb renders as a real button so it is keyboard-operable,
  // matching the accessible pattern used for the sidebar's Agents nav item.
  if (crumb.onClick) {
    return (
...
type AppShellProps = {
  ...
  readonly onNavigateAgents?: () => void;
};
...
export const AppShell = ({
  ...
  <SidebarProvider className="h-svh">
    <AppSidebar onNavigateAgents={onNavigateAgents} />
    <SidebarInset>

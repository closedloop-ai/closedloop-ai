...
import { CommentAuthorKind } from "../mock";

// Presentational mirror of packages/app/shared/components/comment-avatar.tsx.
// That domain component can't be imported into the prototype sandbox (only
// @repo/design-system is available), so it is replicated faithfully here on
// the same DS Avatar primitive and the same rounded-[8px] treatment.
...
export function CommentAvatar({
  ...
  if (authorKind === CommentAuthorKind.Bot) {
    return (
      <span
        className={cn(

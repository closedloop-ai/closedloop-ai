...
// Kept identical to the Branches prototype's stand-in so both foundations share
// one shape when it is promoted.
  ...
  return (
    <section>
      <button
        ...
        data-session-properties-disclosure="true"
      ...
      {!open && summary ? (
        <button
          className="mt-2 flex w-full flex-wrap items-center gap-x-4 gap-y-2 rounded-lg border bg-card px-3 py-2 text-left text-sm"

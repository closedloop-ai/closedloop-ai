// Prototype-local session fixtures. No DB / API / auth.
...
export const artifactsNav: readonly NavItem[] = [
  ...
  { label: "Agentic Components", icon: "agents" },
];
...
const allSessionRows: readonly SessionRow[] = [
  {
    ...
    extraBranches: [
      "agent/repo-overrides-workspace-config",
      "fix/session-cost-rounding",
    ],
    prNumber: 1284,
...
const historicalSessionRows: readonly SessionRow[] = [
  {
    ...allSessionRows[4]!,
    apiEquivalentCost: 27.64,
    cost: 14.82,
    externalSessionId: "019f0b63-1f11-7f02-8e9c-75-day-session-fixture",
    id: "ses_1e43",
    lastActivityAgoMinutes: 75 * 24 * 60,
    name: "Migrate legacy artifact relationships",
    startedAgoMinutes: 75 * 24 * 60 + 96,
    updatedAgoMinutes: 75 * 24 * 60,
  },
  {
    ...allSessionRows[5]!,
    apiEquivalentCost: 8.92,
    cost: 4.61,
    externalSessionId: "019edc21-7a44-70d1-9af3-110-day-session-fixture",
    id: "ses_0d19",
    lastActivityAgoMinutes: 110 * 24 * 60,
    name: "Audit early project view conventions",
    startedAgoMinutes: 110 * 24 * 60 + 38,
    updatedAgoMinutes: 110 * 24 * 60,
  },
];

/**
 * Production-derived and historical fixtures intentionally span every date
 * range boundary so the list filters and aggregate cards visibly respond.
 */

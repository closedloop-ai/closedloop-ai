...
import { createStubJobStore } from "../jobs/job-store.js";
...
// both Electron (runtime) and Node.js (tests). A named import of the electron
// module fails outside the Electron process because the CJS shim exports only
// a default.

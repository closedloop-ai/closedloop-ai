...
<CardGroup>
  ...
  <Card title="Install the plugins" href="/getting-started/install-plugins">
    One-line install for the six Claude Code plugins, plus interactive and development install paths.
  </Card>

  <Card title="Install the desktop client" href="/getting-started/install-desktop">
    Install, launch, and authenticate the desktop client and its localhost gateway.
  </Card>

  <Card title="Prepare your repo and targets" href="/getting-started/prepare-your-repo-and-targets">
  ...
  <Card title="Run your first loop" href="/getting-started/first-loop">

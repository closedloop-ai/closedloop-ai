...
4. Report `installed / updated / up-to-date / failed` counts for each plugin.
5. Enable auto-update by default so the plugins stay current.
...
You should see all six ClosedLoop plugins listed with their versions.

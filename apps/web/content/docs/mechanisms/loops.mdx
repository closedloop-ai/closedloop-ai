...
A loop can safely run in parallel with another loop in a different worktree. See [Worktree](../glossary/worktree) for the underlying primitive that makes parallel feature development safe.

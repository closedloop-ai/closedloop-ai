...
<Cards>
  <Card title="Install and onboard" href="./getting-started">
...
The result is a system where tickets become tasks, epics become features, and sprints of scope can land in a few PRs — without the churn of chat-driven workflows.

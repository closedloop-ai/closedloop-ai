...
<CardGroup>
  ...
  <Card title="Run the canonical workflow" href="/workflows/planning-with-codex">
...
<CardGroup>
  ...
  <Card title="Sessions" href="/docs/mechanisms/sessions">
    The list, detail, and trace of every AI coding run Closedloop.ai observes, plus the filters, status model, cost buckets, and PR/branch attribution behind it.
  </Card>

  <Card title="Agent components" href="/docs/mechanisms/agent-components">
    The catalog of agentic building blocks — sub-agents, commands, skills, tools, and more — that each session uses.
  </Card>
</CardGroup>
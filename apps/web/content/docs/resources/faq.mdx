...
- Linux — supported for development by running from source; not packaged.
...
Use the repository issues for [`closedloop-ai/closedloop-ai`](https://github.com/closedloop-ai/closedloop-ai/issues) (platform and desktop client) or [`closedloop-ai/claude-plugins`](https://github.com/closedloop-ai/claude-plugins/issues) (Claude Code plugins).

### Where is the source?

- Desktop client: [`closedloop-ai/closedloop-ai`](https://github.com/closedloop-ai/closedloop-ai) under `apps/desktop`.
- Claude Code plugins: [`closedloop-ai/claude-plugins`](https://github.com/closedloop-ai/claude-plugins) (Apache 2.0).

...
Use the repository issues for `closedloop-ai/symphony-alpha` and `closedloop-ai/claude-plugins`.

### Where is the source?

- Desktop client: `closedloop-ai/symphony-alpha` under `apps/desktop` on GitHub.

...
vi.mock("next/navigation", () => ({
  ...
  usePathname: vi.fn(() => "/test-org/implementation-plans/test"),
  useRouter: vi.fn(() => ({ push: vi.fn(), replace: vi.fn() })),
}));

// Mock JudgeResultCard to simplify testing
vi.mock("@repo/app/documents/components/judge-result-card", () => ({
...
vi.mock("@repo/app/documents/components/editor/rating-section", () => ({
  RatingSection: () => (

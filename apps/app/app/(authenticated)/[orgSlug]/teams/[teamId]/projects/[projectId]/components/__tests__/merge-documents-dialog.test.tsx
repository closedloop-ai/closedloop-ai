...
// Mock DocumentTypeBadge to simplify rendering
vi.mock("../document-type-badge", () => ({
...
function renderDialog(props: {
  artifacts?: [DocumentWithProject, DocumentWithProject];
  open?: boolean;
  ...
  return render(<MergeDocumentsDialog {...defaultProps} />);
}

describe("MergeDocumentsDialog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

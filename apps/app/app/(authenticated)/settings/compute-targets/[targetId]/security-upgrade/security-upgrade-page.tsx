...
import {
  ...
  type TargetSecurity,
} from "../../../components/desktop-security-helpers";
import { DesktopUpdateDownloadButton } from "../../../components/desktop-update-download-button";
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {commandExpiresAt ? (
              <div className="flex items-center gap-2 rounded-md border border-emerald-200 bg-emerald-50 p-3 text-emerald-900 text-sm">

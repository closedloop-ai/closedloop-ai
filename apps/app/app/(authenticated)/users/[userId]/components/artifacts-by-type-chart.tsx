...
import type { ArtifactsByType } from "@repo/api/src/types/user";
import {
  ChartContainer,
  ChartTooltip,
  ChartTooltipContent,
...
type ArtifactsByTypeChartProps = {
  data: ArtifactsByType[];
};

export function ArtifactsByTypeChart({ data }: ArtifactsByTypeChartProps) {

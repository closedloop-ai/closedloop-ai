...
export const PRD_TEMPLATE_OPTIONS = ["Standard PRD", "Feature Brief", "Bug Fix", "Technical Spec"] as const;
...
export const IMPL_PLAN_STATUS_OPTIONS = ["Draft", "Ready", "In Progress", "Generating", "Failed", "Archived"] as const;
export type ImplPlanStatus = (typeof IMPL_PLAN_STATUS_OPTIONS)[number];

export const IMPL_PLAN_TYPE_OPTIONS = ["Standard", "Quick", "Detailed", "Technical"] as const;

 ...
 * Returns all artifacts where subtype=TEMPLATE for the authenticated user's organization.
 * Templates have subtype=TEMPLATE with templateForSubtype indicating what they template for.
 */

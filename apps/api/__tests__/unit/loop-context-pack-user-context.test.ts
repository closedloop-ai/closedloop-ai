...
// artifactLinksService (its real impl hits the DB). This suite covers
// userContext/contextRef behavior with no linked evergreen Documents, so stub
// it to return no source links.

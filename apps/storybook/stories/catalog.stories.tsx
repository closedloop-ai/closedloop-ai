    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-8 p-6">
      <header className="max-w-3xl space-y-4">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">
          ...
          this list cannot fall behind what exists. Read Introduction first if
          you have not: it explains the four levels these entries are filed
          under.
        </p>
      </header>
...
/**
 * Every entry in the system, generated from the filesystem, with a live preview
 * and a link into each story. Introduction, above it, is the prose half.
 *

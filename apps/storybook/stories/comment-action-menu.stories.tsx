...
/**
 * The dropdown menu from a comment's ellipsis button, with actions like
 * Edit, Delete, and Copy Link, plus Resolve and Chat About This when the
 * hosting surface supports them.
 */
const meta = {
